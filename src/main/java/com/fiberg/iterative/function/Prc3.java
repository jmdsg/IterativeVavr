...
public interface Prc3<T1, T2, T3> extends CheckedFunction3<T1, T2, T3, Boolean> {
    ...
    public static <T1, T2, T3> Prc3<T1, T2, T3> value(Boolean b) {
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> b;
    }
    ...
    public static <T1, T2, T3> Prc3<T1, T2, T3> detuple(Prc1<? super Tuple3<? extends T1, ? extends T2, ? extends T3>> p) {
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> p.test((Object) Tuple.of((Object) t1, (Object) t2, (Object) t3));
    }
    ...
    default public Prc2<T2, T3> testLt(T1 t1) {
        return (Prc2<Object, Object> & Serializable) (t2, t3) -> this.test(t1, t2, t3);
    }

    default public Prc1<T3> testLt(T1 t1, T2 t2) {
        return (Prc1 & Serializable) t3 -> this.test(t1, t2, t3);
    }

    default public Prc2<T1, T2> testRt(T3 t3) {
        return (Prc2<Object, Object> & Serializable) (t1, t2) -> this.test(t1, t2, t3);
    }

    default public Prc1<T1> testRt(T2 t2, T3 t3) {
        return (Prc1 & Serializable) t1 -> this.test(t1, t2, t3);
    }
    ...
    default public Prc0 toPredicate(T1 t1, T2 t2, T3 t3) {
        return (Prc0 & Serializable) () -> this.test(t1, t2, t3);
    }
    ...
    default public Prc3<T1, T2, T3> afterRunOn(Rnc onSuccess, Rnc onFailure) {
        ...
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> {
    ...
    default public <R> Fnc3<T1, T2, T3, R> afterApplyOnTo(Fnc1<Boolean, ? extends R> onSuccess, Fnc1<Boolean, ? extends R> onFailure) {
        Objects.requireNonNull(onSuccess, "onSuccess is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Fnc3 & Serializable) (t1, t2, t3) -> {
            Boolean value = this.test(t1, t2, t3);
    ...
    default public <W> Fn3<T1, T2, T3, W> beforeWrapTo(Fn1<? super Spc<Boolean>, ? extends W> wrap) {
        return (Fn3 & Serializable) (t1, t2, t3) -> wrap.apply(this.toSupplier(t1, t2, t3));
    }
    ...
    default public <B1> Prc1<B1> beforeApply1(Fnc1<? super B1, ? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> f) {
        ...
        return (Prc1 & Serializable) b1 -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) f.apply(b1))));
    }

    default public <B1, B2> Prc2<B1, B2> beforeApply2(Fnc2<? super B1, ? super B2, ? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Prc2<Object, Object> & Serializable) (b1, b2) -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) f.apply(b1, b2))));
    }
    ...
    default public <B1, B2, B3> Prc3<B1, B2, B3> beforeApply3(Fnc3<? super B1, ? super B2, ? super B3, ? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Prc3<Object, Object, Object> & Serializable) (b1, b2, b3) -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) f.apply(b1, b2, b3))));
    }
    ...
    default public <B1, B2, B3, B4> Prc4<B1, B2, B3, B4> beforeApply4(Fnc4<? super B1, ? super B2, ? super B3, ? super B4, ? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Prc4<Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4) -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) f.apply(b1, b2, b3, b4))));
    }
    ...
    default public <B1, B2, B3, B4, B5> Prc5<B1, B2, B3, B4, B5> beforeApply5(Fnc5<? super B1, ? super B2, ? super B3, ? super B4, ? super B5, ? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Prc5<Object, Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4, b5) -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) f.apply(b1, b2, b3, b4, b5))));
    }
    ...
    default public <B1, B2, B3, B4, B5, B6> Prc6<B1, B2, B3, B4, B5, B6> beforeApply6(Fnc6<? super B1, ? super B2, ? super B3, ? super B4, ? super B5, ? super B6, ? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Prc6<Object, Object, Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4, b5, b6) -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) f.apply(b1, b2, b3, b4, b5, b6))));
    }
    ...
    default public <B1, B2, B3, B4, B5, B6, B7> Prc7<B1, B2, B3, B4, B5, B6, B7> beforeApply7(Fnc7<? super B1, ? super B2, ? super B3, ? super B4, ? super B5, ? super B6, ? super B7, ? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Prc7<Object, Object, Object, Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4, b5, b6, b7) -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) f.apply(b1, b2, b3, b4, b5, b6, b7))));
    }
    ...
    default public <B1, B2, B3, B4, B5, B6, B7, B8> Prc8<B1, B2, B3, B4, B5, B6, B7, B8> beforeApply8(Fnc8<? super B1, ? super B2, ? super B3, ? super B4, ? super B5, ? super B6, ? super B7, ? super B8, ? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Prc8<Object, Object, Object, Object, Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4, b5, b6, b7, b8) -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) f.apply(b1, b2, b3, b4, b5, b6, b7, b8))));
    }

    default public Prc3<T1, T2, T3> beforeTestOnSuccess(Prc0 p, Prc3<? super T1, ? super T2, ? super T3> onFailure) {
        Objects.requireNonNull(p, "p is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> p.test() != false ? this.test(t1, t2, t3) : onFailure.test(t1, t2, t3);
    }
    ...
    default public Prc0 beforeGet(Spc<? extends Tuple3<? extends T1, ? extends T2, ? extends T3>> s) {
        ...
        return (Prc0 & Serializable) () -> this.tupled().test((Object) Tuple.narrow((Tuple3) ((Tuple3) s.get())));
    }

    default public Prc3<T3, T2, T1> inverted() {
        return (Prc3<Object, Object, Object> & Serializable) (t3, t2, t1) -> this.test(t1, t2, t3);
    }
    ...
    default public <S> Fnc3<T1, T2, T3, S> afterPassingThroughApplyOnTo(Fnc3<? super T1, ? super T2, ? super T3, ? extends S> onSuccess, Fnc3<? super T1, ? super T2, ? super T3, ? extends S> onFailure) {
        Objects.requireNonNull(onSuccess, "onSuccess is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Fnc3 & Serializable) (t1, t2, t3) -> Fnc3.narrow(this.test(t1, t2, t3) ? onSuccess : onFailure).apply(t1, t2, t3);
    }
    ...
    default public Prc3<T1, T2, T3> afterPassingThroughTestOn(Prc3<? super T1, ? super T2, ? super T3> onSuccess, Prc3<? super T1, ? super T2, ? super T3> onFailure) {
        Objects.requireNonNull(onSuccess, "onSuccess is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> Prc3.narrow(this.test(t1, t2, t3) ? onSuccess : onFailure).test(t1, t2, t3);
    }
    ...
    default public Prc3<T1, T2, T3> beforeSuccessPassingThroughTest(Prc3<? super T1, ? super T2, ? super T3> p, Prc3<? super T1, ? super T2, ? super T3> onFailure) {
        Objects.requireNonNull(p, "p is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> p.test(t1, t2, t3) ? this.test(t1, t2, t3) : onFailure.test(t1, t2, t3);
    }
    ...
    default public Prc1<Tuple3<T1, T2, T3>> tupled() {
        return (Prc1 & Serializable) tuple -> this.test(tuple._1(), tuple._2(), tuple._3());
    }

    default public Fnc1<T1, Fnc1<T2, Prc1<T3>>> currying() {
        return (Fnc1 & Serializable) t1 -> (Fnc1 & Serializable) t2 -> (Prc1 & Serializable) t3 -> this.test(t1, t2, t3);
    }
    ...
    default public Prc3<T1, T2, T3> negated() {
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> !this.test(t1, t2, t3);
    }

    default public Prc3<T1, T2, T3> and(Prc3<? super T1, ? super T2, ? super T3> p) {
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> this.test(t1, t2, t3) && p.test(t1, t2, t3);
    }
    ...
    default public Prc3<T1, T2, T3> and(Prc0 p) {
        return (Prc3<Object, Object, Object> & Serializable) (t1, t2, t3) -> this.test(t1, t2, t3) && p.test() != false;
    }
    ...
    default public <I1> Prc4<I1, T1, T2, T3> ignoring1Lt() {
        return (Prc4<Object, Object, Object, Object> & Serializable) (i1, t1, t2, t3) -> this.test(t1, t2, t3);
    }

    default public <I1> Prc4<T1, T2, T3, I1> ignoring1Rt() {
        return (Prc4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, i1) -> this.test(t1, t2, t3);
    }

    default public <I1, I2> Prc5<I1, I2, T1, T2, T3> ignoring2Lt() {
        return (Prc5<Object, Object, Object, Object, Object> & Serializable) (i1, i2, t1, t2, t3) -> this.test(t1, t2, t3);
    }

    default public <I1, I2> Prc5<T1, T2, T3, I1, I2> ignoring2Rt() {
        return (Prc5<Object, Object, Object, Object, Object> & Serializable) (t1, t2, t3, i1, i2) -> this.test(t1, t2, t3);
    }

    default public <I1, I2, I3> Prc6<I1, I2, I3, T1, T2, T3> ignoring3Lt() {
        return (Prc6<Object, Object, Object, Object, Object, Object> & Serializable) (i1, i2, i3, t1, t2, t3) -> this.test(t1, t2, t3);
    }

    default public <I1, I2, I3> Prc6<T1, T2, T3, I1, I2, I3> ignoring3Rt() {
        return (Prc6<Object, Object, Object, Object, Object, Object> & Serializable) (t1, t2, t3, i1, i2, i3) -> this.test(t1, t2, t3);
    }

    default public <I1, I2, I3, I4> Prc7<I1, I2, I3, I4, T1, T2, T3> ignoring4Lt() {
        return (Prc7<Object, Object, Object, Object, Object, Object, Object> & Serializable) (i1, i2, i3, i4, t1, t2, t3) -> this.test(t1, t2, t3);
    }

    default public <I1, I2, I3, I4> Prc7<T1, T2, T3, I1, I2, I3, I4> ignoring4Rt() {
        return (Prc7<Object, Object, Object, Object, Object, Object, Object> & Serializable) (t1, t2, t3, i1, i2, i3, i4) -> this.test(t1, t2, t3);
    }

    default public <I1, I2, I3, I4, I5> Prc8<I1, I2, I3, I4, I5, T1, T2, T3> ignoring5Lt() {
        return (Prc8<Object, Object, Object, Object, Object, Object, Object, Object> & Serializable) (i1, i2, i3, i4, i5, t1, t2, t3) -> this.test(t1, t2, t3);
    }

    default public <I1, I2, I3, I4, I5> Prc8<T1, T2, T3, I1, I2, I3, I4, I5> ignoring5Rt() {
        return (Prc8<Object, Object, Object, Object, Object, Object, Object, Object> & Serializable) (t1, t2, t3, i1, i2, i3, i4, i5) -> this.test(t1, t2, t3);
    }
