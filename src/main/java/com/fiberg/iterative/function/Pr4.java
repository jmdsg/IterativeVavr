...
public interface Pr4<T1, T2, T3, T4> extends Function4<T1, T2, T3, T4, Boolean> {
    ...
    public static <T1, T2, T3, T4> Pr4<T1, T2, T3, T4> value(Boolean b) {
        return (Pr4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4) -> b;
    }
    ...
    public static <T1, T2, T3, T4> Pr4<T1, T2, T3, T4> detuple(Pr1<? super Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> p) {
        return (Pr4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4) -> p.test(Tuple.of((Object) t1, (Object) t2, (Object) t3, (Object) t4));
    }
    ...
    default public Pr3<T2, T3, T4> testLt(T1 t1) {
        return (Pr3<Object, Object, Object> & Serializable) (t2, t3, t4) -> this.test(t1, t2, t3, t4);
    }

    default public Pr2<T3, T4> testLt(T1 t1, T2 t2) {
        return (Pr2<Object, Object> & Serializable) (t3, t4) -> this.test(t1, t2, t3, t4);
    }

    default public Pr1<T4> testLt(T1 t1, T2 t2, T3 t3) {
        return (Pr1 & Serializable) t4 -> this.test(t1, t2, t3, t4);
    }

    default public Pr3<T1, T2, T3> testRt(T4 t4) {
        return (Pr3<Object, Object, Object> & Serializable) (t1, t2, t3) -> this.test(t1, t2, t3, t4);
    }

    default public Pr2<T1, T2> testRt(T3 t3, T4 t4) {
        return (Pr2<Object, Object> & Serializable) (t1, t2) -> this.test(t1, t2, t3, t4);
    }

    default public Pr1<T1> testRt(T2 t2, T3 t3, T4 t4) {
        return (Pr1 & Serializable) t1 -> this.test(t1, t2, t3, t4);
    }
    ...
    default public Pr0 toPredicate(T1 t1, T2 t2, T3 t3, T4 t4) {
        return (Pr0 & Serializable) () -> this.test(t1, t2, t3, t4);
    }
    ...
    default public <R> R passEvalued(Sp<? extends R> onSuccess, Sp<? extends R> onFailure, T1 t1, T2 t2, T3 t3, T4 t4) {
        return (R) this.toPredicate(t1, t2, t3, t4).evalued(onSuccess, onFailure);
    }
    ...
    default public <R> R passEvaluedOnSuccess(Sp<? extends R> onSuccess, T1 t1, T2 t2, T3 t3, T4 t4) {
        return (R) this.toPredicate(t1, t2, t3, t4).evaluedOnSuccess(onSuccess);
    }

    default public <R> R passEvaluedOnFailure(Sp<? extends R> onFailure, T1 t1, T2 t2, T3 t3, T4 t4) {
        return (R) this.toPredicate(t1, t2, t3, t4).evaluedOnFailure(onFailure);
    }
    ...
    default public <B1> Pr1<B1> beforeApply1(Fn1<? super B1, ? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> f) {
        ...
        return (Pr1 & Serializable) b1 -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) f.apply(b1))));
    }
    ...
    default public <B1, B2> Pr2<B1, B2> beforeApply2(Fn2<? super B1, ? super B2, ? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Pr2<Object, Object> & Serializable) (b1, b2) -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) f.apply(b1, b2))));
    }
    ...
    default public <B1, B2, B3> Pr3<B1, B2, B3> beforeApply3(Fn3<? super B1, ? super B2, ? super B3, ? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Pr3<Object, Object, Object> & Serializable) (b1, b2, b3) -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) f.apply(b1, b2, b3))));
    }
    ...
    default public <B1, B2, B3, B4> Pr4<B1, B2, B3, B4> beforeApply4(Fn4<? super B1, ? super B2, ? super B3, ? super B4, ? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Pr4<Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4) -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) f.apply(b1, b2, b3, b4))));
    }
    ...
    default public <B1, B2, B3, B4, B5> Pr5<B1, B2, B3, B4, B5> beforeApply5(Fn5<? super B1, ? super B2, ? super B3, ? super B4, ? super B5, ? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Pr5<Object, Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4, b5) -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) f.apply(b1, b2, b3, b4, b5))));
    }
    ...
    default public <B1, B2, B3, B4, B5, B6> Pr6<B1, B2, B3, B4, B5, B6> beforeApply6(Fn6<? super B1, ? super B2, ? super B3, ? super B4, ? super B5, ? super B6, ? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Pr6<Object, Object, Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4, b5, b6) -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) f.apply(b1, b2, b3, b4, b5, b6))));
    }
    ...
    default public <B1, B2, B3, B4, B5, B6, B7> Pr7<B1, B2, B3, B4, B5, B6, B7> beforeApply7(Fn7<? super B1, ? super B2, ? super B3, ? super B4, ? super B5, ? super B6, ? super B7, ? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Pr7<Object, Object, Object, Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4, b5, b6, b7) -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) f.apply(b1, b2, b3, b4, b5, b6, b7))));
    }
    ...
    default public <B1, B2, B3, B4, B5, B6, B7, B8> Pr8<B1, B2, B3, B4, B5, B6, B7, B8> beforeApply8(Fn8<? super B1, ? super B2, ? super B3, ? super B4, ? super B5, ? super B6, ? super B7, ? super B8, ? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> f) {
        Objects.requireNonNull(f, "f is null");
        return (Pr8<Object, Object, Object, Object, Object, Object, Object, Object> & Serializable) (b1, b2, b3, b4, b5, b6, b7, b8) -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) f.apply(b1, b2, b3, b4, b5, b6, b7, b8))));
    }

    default public Pr4<T1, T2, T3, T4> beforeTestOnSuccess(Pr0 p, Pr4<? super T1, ? super T2, ? super T3, ? super T4> onFailure) {
        Objects.requireNonNull(p, "p is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Pr4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4) -> p.test() ? this.test(t1, t2, t3, t4) : onFailure.test(t1, t2, t3, t4);
    }
    ...
    default public Pr0 beforeGet(Sp<? extends Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4>> s) {
        ...
        return (Pr0 & Serializable) () -> this.tupled().test(Tuple.narrow((Tuple4) ((Tuple4) s.get())));
    }

    default public Pr4<T4, T3, T2, T1> inverted() {
        return (Pr4<Object, Object, Object, Object> & Serializable) (t4, t3, t2, t1) -> this.test(t1, t2, t3, t4);
    }
    ...
    default public <S> Fn4<T1, T2, T3, T4, S> afterPassingThroughApplyOnTo(Fn4<? super T1, ? super T2, ? super T3, ? super T4, ? extends S> onSuccess, Fn4<? super T1, ? super T2, ? super T3, ? super T4, ? extends S> onFailure) {
        Objects.requireNonNull(onSuccess, "onSuccess is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Fn4 & Serializable) (t1, t2, t3, t4) -> Fn4.narrow(this.test(t1, t2, t3, t4) ? onSuccess : onFailure).apply(t1, t2, t3, t4);
    }
    ...
    default public Pr4<T1, T2, T3, T4> afterPassingThroughTestOn(Pr4<? super T1, ? super T2, ? super T3, ? super T4> onSuccess, Pr4<? super T1, ? super T2, ? super T3, ? super T4> onFailure) {
        Objects.requireNonNull(onSuccess, "onSuccess is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Pr4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4) -> Pr4.narrow(this.test(t1, t2, t3, t4) ? onSuccess : onFailure).test(t1, t2, t3, t4);
    }
    ...
    default public Pr4<T1, T2, T3, T4> beforeSuccessPassingThroughTest(Pr4<? super T1, ? super T2, ? super T3, ? super T4> p, Pr4<? super T1, ? super T2, ? super T3, ? super T4> onFailure) {
        Objects.requireNonNull(p, "p is null");
        Objects.requireNonNull(onFailure, "onFailure is null");
        return (Pr4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4) -> p.test(t1, t2, t3, t4) ? this.test(t1, t2, t3, t4) : onFailure.test(t1, t2, t3, t4);
    }
    ...
    default public Pr1<Tuple4<T1, T2, T3, T4>> tupled() {
        return (Pr1 & Serializable) tuple -> this.test(tuple._1(), tuple._2(), tuple._3(), tuple._4());
    }
    ...
    default public Fn1<T1, Fn1<T2, Fn1<T3, Pr1<T4>>>> currying() {
        return (Fn1 & Serializable) t1 -> (Fn1 & Serializable) t2 -> (Fn1 & Serializable) t3 -> (Pr1 & Serializable) t4 -> this.test(t1, t2, t3, t4);
    }

    default public Pr4<T1, T2, T3, T4> negated() {
        return (Pr4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4) -> !this.test(t1, t2, t3, t4);
    }

    default public Pr4<T1, T2, T3, T4> and(Pr4<? super T1, ? super T2, ? super T3, ? super T4> p) {
        return (Pr4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4) -> this.test(t1, t2, t3, t4) && p.test(t1, t2, t3, t4);
    }
    ...
    default public Pr4<T1, T2, T3, T4> and(Pr0 p) {
        return (Pr4<Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4) -> this.test(t1, t2, t3, t4) && p.test();
    }
    ...
    default public <I1> Pr5<I1, T1, T2, T3, T4> ignoring1Lt() {
        return (Pr5<Object, Object, Object, Object, Object> & Serializable) (i1, t1, t2, t3, t4) -> this.test(t1, t2, t3, t4);
    }

    default public <I1> Pr5<T1, T2, T3, T4, I1> ignoring1Rt() {
        return (Pr5<Object, Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4, i1) -> this.test(t1, t2, t3, t4);
    }

    default public <I1, I2> Pr6<I1, I2, T1, T2, T3, T4> ignoring2Lt() {
        return (Pr6<Object, Object, Object, Object, Object, Object> & Serializable) (i1, i2, t1, t2, t3, t4) -> this.test(t1, t2, t3, t4);
    }

    default public <I1, I2> Pr6<T1, T2, T3, T4, I1, I2> ignoring2Rt() {
        return (Pr6<Object, Object, Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4, i1, i2) -> this.test(t1, t2, t3, t4);
    }

    default public <I1, I2, I3> Pr7<I1, I2, I3, T1, T2, T3, T4> ignoring3Lt() {
        return (Pr7<Object, Object, Object, Object, Object, Object, Object> & Serializable) (i1, i2, i3, t1, t2, t3, t4) -> this.test(t1, t2, t3, t4);
    }

    default public <I1, I2, I3> Pr7<T1, T2, T3, T4, I1, I2, I3> ignoring3Rt() {
        return (Pr7<Object, Object, Object, Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4, i1, i2, i3) -> this.test(t1, t2, t3, t4);
    }

    default public <I1, I2, I3, I4> Pr8<I1, I2, I3, I4, T1, T2, T3, T4> ignoring4Lt() {
        return (Pr8<Object, Object, Object, Object, Object, Object, Object, Object> & Serializable) (i1, i2, i3, i4, t1, t2, t3, t4) -> this.test(t1, t2, t3, t4);
    }

    default public <I1, I2, I3, I4> Pr8<T1, T2, T3, T4, I1, I2, I3, I4> ignoring4Rt() {
        return (Pr8<Object, Object, Object, Object, Object, Object, Object, Object> & Serializable) (t1, t2, t3, t4, i1, i2, i3, i4) -> this.test(t1, t2, t3, t4);
    }
