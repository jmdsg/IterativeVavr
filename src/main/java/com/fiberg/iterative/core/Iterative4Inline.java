...
public interface Iterative4Inline<T1, T2, T3, T4> extends Iterative4<T1, T2, T3, T4> {
    ...
    default public <B1, B2, B3> Iterative7Inline<T1, T2, T3, T4, B1, B2, B3> pushBackBy(Iterable<? extends Stream<? extends B1>> b1, Iterable<? extends Stream<? extends B2>> b2, Iterable<? extends Stream<? extends B3>> b3) {
        return (Iterative7Inline<T1, T2, T3, T4, B1, B2, B3>) Iterative4.super.<B1, B2, B3>pushBackBy(b1, b2, b4);
    }
    ...
    public static abstract class Iterative4InlineAbstract<T1, T2, T3, T4> extends Iterative4.Iterative4Abstract<T1, T2, T3, T4> implements Iterative4Inline<T1, T2, T3, T4> {
        ...
        public Stream<Tuple4<Iterable<T1>, Iterable<T2>, Iterable<T3>, Iterable<T4>>> toTupleStream() {
            ZipIterator iterator = new ZipIterator(this.iterative.toTupleStream().iterator(), IterativeHandler.transform(this.right).iterator(), (tuple, right) -> Tuple.of(tuple._1(), tuple._2(), tuple._3(), right));
