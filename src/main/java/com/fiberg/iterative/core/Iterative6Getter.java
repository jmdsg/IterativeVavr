...
public interface Iterative6Getter<G1, G2, G3, G4, G5, G6> extends IterativeGetter {
    ...
    public <R> Iterative6Fail<G1, G2, G3, G4, G5, G6, R> onSuccess(Fn1<? super Iterative6<? extends G1, ? extends G2, ? extends G3, ? extends G4, ? extends G5, ? extends G6>, ? extends R> f1);

    public <R> Iterative6Fail<G1, G2, G3, G4, G5, G6, R> onSuccess(Sp<? extends R> s1);

    public <R> Iterative6Fail<G1, G2, G3, G4, G5, G6, R> onSuccess(R r);

    public <R> Iterative6Success<G1, G2, G3, G4, G5, G6, R> onFailure(Fn1<? super Iterative6<? extends G1, ? extends G2, ? extends G3, ? extends G4, ? extends G5, ? extends G6>, ? extends R> f1);

    public <R> Iterative6Success<G1, G2, G3, G4, G5, G6, R> onFailure(Sp<? extends R> s1);
    ...
    public static interface Iterative6Success<G1, G2, G3, G4, G5, G6, R> {
        ...
        public R onSuccess(Fn1<? super Iterative6<? extends G1, ? extends G2, ? extends G3, ? extends G4, ? extends G5, ? extends G6>, ? extends R> f1);
    ...
    public static interface Iterative6Fail<G1, G2, G3, G4, G5, G6, R> {
        ...
        public R onFailure(Fn1<? super Iterative6<? extends G1, ? extends G2, ? extends G3, ? extends G4, ? extends G5, ? extends G6>, ? extends R> f1);
    ...
    public static class Iterative6GetterImpl<G1, G2, G3, G4, G5, G6> implements Iterative6Getter<G1, G2, G3, G4, G5, G6> {
        ...
        @Override
        public Iterative6Fail<G1, G2, G3, G4, G5, G6, Tuple6<G1, G2, G3, G4, G5, G6>> onSuccess() {
            return new Iterative6Fail.Iterative6FailImpl<>(this.iterative, () -> this.iterative.<Tuple6<G1, G2, G3, G4, G5, G6>>yieldOption(Tuple::of).get());
        }
        ...
        public <R> Iterative6Fail<G1, G2, G3, G4, G5, G6, R> onSuccess(Fn1<? super Iterative6<? extends G1, ? extends G2, ? extends G3, ? extends G4, ? extends G5, ? extends G6>, ? extends R> f) {
            Objects.requireNonNull(f, "f is null");
            return new Iterative6Fail.Iterative6FailImpl<>(this.iterative, f.toSupplier(this.iterative));
        }

        @Override
        public <R> Iterative6Fail<G1, G2, G3, G4, G5, G6, R> onSuccess(Sp<? extends R> s) {
            Objects.requireNonNull(s, "s is null");
            return new Iterative6Fail.Iterative6FailImpl<>(this.iterative, s);
        }

        @Override
        public <R> Iterative6Fail<G1, G2, G3, G4, G5, G6, R> onSuccess(R r) {
            return new Iterative6Fail.Iterative6FailImpl<>(this.iterative, () -> r);
        }
        ...
        public <R> Iterative6Success<G1, G2, G3, G4, G5, G6, R> onFailure(Fn1<? super Iterative6<? extends G1, ? extends G2, ? extends G3, ? extends G4, ? extends G5, ? extends G6>, ? extends R> f) {
            Objects.requireNonNull(f, "f is null");
            return new Iterative6Success.Iterative6SuccessImpl<>(this.iterative, f.toSupplier(this.iterative));
        }

        @Override
        public <R> Iterative6Success<G1, G2, G3, G4, G5, G6, R> onFailure(Sp<? extends R> s) {
            Objects.requireNonNull(s, "s is null");
            return new Iterative6Success.Iterative6SuccessImpl<>(this.iterative, s);
        }

        @Override
        public <R> Iterative6Success<G1, G2, G3, G4, G5, G6, R> onFailure(R r) {
            return new Iterative6Success.Iterative6SuccessImpl<>(this.iterative, () -> r);
        }
