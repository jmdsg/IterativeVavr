...
public interface Iterative4Args<T1, T2, T3, T4> {
    ...
    public static interface Iterative4Args4<T1, T2, T3, T4, A1, A2, A3, A4> extends Iterative4Args<T1, T2, T3, T4> {
        ...
        public static class Iterative4Args4Impl<T1, T2, T3, T4, A1, A2, A3, A4> implements Iterative4Args4<T1, T2, T3, T4, A1, A2, A3, A4> {
            ...
            public <R1, R2, R3, R4> Iterative4<R1, R2, R3, R4> mapping(Fn5<? super T1, ? super A1, ? super A2, ? super A3, ? super A4, ? extends R1> f1, Fn5<? super T2, ? super A1, ? super A2, ? super A3, ? super A4, ? extends R2> f2, Fn5<? super T3, ? super A1, ? super A2, ? super A3, ? super A4, ? extends R3> f3, Fn5<? super T4, ? super A1, ? super A2, ? super A3, ? super A4, ? extends R4> f4) {
                ...
                return this.left.create(this.left.splitLt3().create(this.left.splitLt2().create(this.left.splitLt1().create((this.cross ? i1.pushBackCrossOf(stream) : i1.pushBackInlineOf(stream)).reduce((Fn2 & Serializable)(t1, tuple) -> f1.apply(t1, tuple._1(), tuple._2(), tuple._3(), tuple._4())).iterableStream1()), (this.cross ? i2.pushBackCrossOf(stream) : i2.pushBackInlineOf(stream)).reduce((Fn2 & Serializable)(t2, tuple) -> f2.apply(t2, tuple._1(), tuple._2(), tuple._3(), tuple._4())).iterableStream1()), (this.cross ? i3.pushBackCrossOf(stream) : i3.pushBackInlineOf(stream)).reduce((Fn2 & Serializable)(t3, tuple) -> f3.apply(t3, tuple._1(), tuple._2(), tuple._3(), tuple._4())).iterableStream1()), (this.cross ? i4.pushBackCrossOf(stream) : i4.pushBackInlineOf(stream)).reduce((Fn2 & Serializable)(t4, tuple) -> f4.apply(t4, tuple._1(), tuple._2(), tuple._3(), tuple._4())).iterableStream1());
            }
            ...
            public <R1, R2, R3, R4> Iterative4<R1, R2, R3, R4> inverseMapping(Fn5<? super A1, ? super A2, ? super A3, ? super A4, ? super T1, ? extends R1> f1, Fn5<? super A1, ? super A2, ? super A3, ? super A4, ? super T2, ? extends R2> f2, Fn5<? super A1, ? super A2, ? super A3, ? super A4, ? super T3, ? extends R3> f3, Fn5<? super A1, ? super A2, ? super A3, ? super A4, ? super T4, ? extends R4> f4) {
                return this.mapping((Fn5 & Serializable)(t1, a1, a2, a3, a4) -> f1.apply(a1, a2, a3, a4, t1), (Fn5 & Serializable)(t2, a1, a2, a3, a4) -> f2.apply(a1, a2, a3, a4, t2), (Fn5 & Serializable)(t3, a1, a2, a3, a4) -> f3.apply(a1, a2, a3, a4, t3), (Fn5 & Serializable)(t4, a1, a2, a3, a4) -> f4.apply(a1, a2, a3, a4, t4));
            }
            ...
            public <R1, R2, R3, R4> Iterative4Args4<T1, T2, T3, T4, R1, R2, R3, R4> map(Fn1<? super A1, ? extends R1> f1, Fn1<? super A2, ? extends R2> f2, Fn1<? super A3, ? extends R3> f3, Fn1<? super A4, ? extends R4> f4) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, R1, R2, R3, R4>(this.left, this.right.map(f1, f2, f3, f4), this.cross);
            }

            @Override
            public <R1> Iterative4Args4<T1, T2, T3, T4, R1, A2, A3, A4> map1(Fn1<? super A1, ? extends R1> f1) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, R1, A2, A3, A4>(this.left, this.right.map1(f1), this.cross);
            }

            @Override
            public <R2> Iterative4Args4<T1, T2, T3, T4, A1, R2, A3, A4> map2(Fn1<? super A2, ? extends R2> f2) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, A1, R2, A3, A4>(this.left, this.right.map2(f2), this.cross);
            }

            @Override
            public <R3> Iterative4Args4<T1, T2, T3, T4, A1, A2, R3, A4> map3(Fn1<? super A3, ? extends R3> f3) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, A1, A2, R3, A4>(this.left, this.right.map3(f3), this.cross);
            }

            @Override
            public <R4> Iterative4Args4<T1, T2, T3, T4, A1, A2, A3, R4> map4(Fn1<? super A4, ? extends R4> f4) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, A1, A2, A3, R4>(this.left, this.right.map4(f4), this.cross);
            }
            ...
            public Iterative4Args4<T1, T2, T3, T4, A1, A2, A3, A4> filter(Pr1<? super A1> p1, Pr1<? super A2> p2, Pr1<? super A3> p3, Pr1<? super A4> p4) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, A1, A2, A3, A4>(this.left, this.right.filter(p1, p2, p3, p4), this.cross);
            }

            @Override
            public Iterative4Args4<T1, T2, T3, T4, A1, A2, A3, A4> filter1(Pr1<? super A1> p1) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, A1, A2, A3, A4>(this.left, this.right.filter1(p1), this.cross);
            }

            @Override
            public Iterative4Args4<T1, T2, T3, T4, A1, A2, A3, A4> filter2(Pr1<? super A2> p2) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, A1, A2, A3, A4>(this.left, this.right.filter2(p2), this.cross);
            }

            @Override
            public Iterative4Args4<T1, T2, T3, T4, A1, A2, A3, A4> filter3(Pr1<? super A3> p3) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, A1, A2, A3, A4>(this.left, this.right.filter3(p3), this.cross);
            }

            @Override
            public Iterative4Args4<T1, T2, T3, T4, A1, A2, A3, A4> filter4(Pr1<? super A4> p4) {
                return new Iterative4Args4Impl<T1, T2, T3, T4, A1, A2, A3, A4>(this.left, this.right.filter4(p4), this.cross);
            }
    ...
    public static interface Iterative4Args3<T1, T2, T3, T4, A1, A2, A3> extends Iterative4Args<T1, T2, T3, T4> {
        ...
        public <R1, R2, R3, R4> Iterative4<R1, R2, R3, R4> inverseapping(Fn4<? super A1, ? super A2, ? super A3, ? super T1, ? extends R1> var1, Fn4<? super A1, ? super A2, ? super A3, ? super T2, ? extends R2> var2, Fn4<? super A1, ? super A2, ? super A3, ? super T3, ? extends R3> var3, Fn4<? super A1, ? super A2, ? super A3, ? super T4, ? extends R4> var4);
        ...
        public static class Iterative4Args3Impl<T1, T2, T3, T4, A1, A2, A3> implements Iterative4Args3<T1, T2, T3, T4, A1, A2, A3> {
            ...
            public <R1, R2, R3, R4> Iterative4<R1, R2, R3, R4> mapping(Fn4<? super T1, ? super A1, ? super A2, ? super A3, ? extends R1> f1, Fn4<? super T2, ? super A1, ? super A2, ? super A3, ? extends R2> f2, Fn4<? super T3, ? super A1, ? super A2, ? super A3, ? extends R3> f3, Fn4<? super T4, ? super A1, ? super A2, ? super A3, ? extends R4> f4) {
                ...
                Iterative1<T3> i3 = this.left.create(this.left.iterableStream3());
                Iterative1<T4> i4 = this.left.create(this.left.iterableStream4());
                return this.left.create(this.left.splitLt3().create(this.left.splitLt2().create(this.left.splitLt1().create((this.cross ? i1.pushBackCrossOf(stream) : i1.pushBackInlineOf(stream)).reduce((Fn2 & Serializable)(t1, tuple) -> f1.apply(t1, tuple._1(), tuple._2(), tuple._3())).iterableStream1()), (this.cross ? i2.pushBackCrossOf(stream) : i2.pushBackInlineOf(stream)).reduce((Fn2 & Serializable)(t2, tuple) -> f2.apply(t2, tuple._1(), tuple._2(), tuple._3())).iterableStream1()), (this.cross ? i3.pushBackCrossOf(stream) : i3.pushBackInlineOf(stream)).reduce((Fn2 & Serializable)(t3, tuple) -> f3.apply(t3, tuple._1(), tuple._2(), tuple._3())).iterableStream1()), (this.cross ? i4.pushBackCrossOf(stream) : i4.pushBackInlineOf(stream)).reduce((Fn2 & Serializable)(t4, tuple) -> f4.apply(t4, tuple._1(), tuple._2(), tuple._3())).iterableStream1());
            }

            @Override
            public <R1, R2, R3, R4> Iterative4<R1, R2, R3, R4> inverseapping(Fn4<? super A1, ? super A2, ? super A3, ? super T1, ? extends R1> f1, Fn4<? super A1, ? super A2, ? super A3, ? super T2, ? extends R2> f2, Fn4<? super A1, ? super A2, ? super A3, ? super T3, ? extends R3> f3, Fn4<? super A1, ? super A2, ? super A3, ? super T4, ? extends R4> f4) {
                return this.mapping((Fn4 & Serializable)(t1, a1, a2, a3) -> f1.apply(a1, a2, a3, t1), (Fn4 & Serializable)(t2, a1, a2, a3) -> f2.apply(a1, a2, a3, t2), (Fn4 & Serializable)(t3, a1, a2, a3) -> f3.apply(a1, a2, a3, t3), (Fn4 & Serializable)(t4, a1, a2, a3) -> f4.apply(a1, a2, a3, t4));
            }
            ...
            public <R1, R2, R3> Iterative4Args3<T1, T2, T3, T4, R1, R2, R3> map(Fn1<? super A1, ? extends R1> f1, Fn1<? super A2, ? extends R2> f2, Fn1<? super A3, ? extends R3> f3) {
                return new Iterative4Args3Impl<T1, T2, T3, T4, R1, R2, R3>(this.left, this.right.map(f1, f2, f3), this.cross);
            }

            @Override
            public <R1> Iterative4Args3<T1, T2, T3, T4, R1, A2, A3> map1(Fn1<? super A1, ? extends R1> f1) {
                return new Iterative4Args3Impl<T1, T2, T3, T4, R1, A2, A3>(this.left, this.right.map1(f1), this.cross);
            }

            @Override
            public <R2> Iterative4Args3<T1, T2, T3, T4, A1, R2, A3> map2(Fn1<? super A2, ? extends R2> f2) {
                return new Iterative4Args3Impl<T1, T2, T3, T4, A1, R2, A3>(this.left, this.right.map2(f2), this.cross);
            }

            @Override
            public <R3> Iterative4Args3<T1, T2, T3, T4, A1, A2, R3> map3(Fn1<? super A3, ? extends R3> f3) {
                return new Iterative4Args3Impl<T1, T2, T3, T4, A1, A2, R3>(this.left, this.right.map3(f3), this.cross);
            }
            ...
            public Iterative4Args3<T1, T2, T3, T4, A1, A2, A3> filter(Pr1<? super A1> p1, Pr1<? super A2> p2, Pr1<? super A3> p3) {
                return new Iterative4Args3Impl<T1, T2, T3, T4, A1, A2, A3>(this.left, this.right.filter(p1, p2, p3), this.cross);
            }

            @Override
            public Iterative4Args3<T1, T2, T3, T4, A1, A2, A3> filter1(Pr1<? super A1> p1) {
                return new Iterative4Args3Impl<T1, T2, T3, T4, A1, A2, A3>(this.left, this.right.filter1(p1), this.cross);
            }

            @Override
            public Iterative4Args3<T1, T2, T3, T4, A1, A2, A3> filter2(Pr1<? super A2> p2) {
                return new Iterative4Args3Impl<T1, T2, T3, T4, A1, A2, A3>(this.left, this.right.filter2(p2), this.cross);
            }

            @Override
            public Iterative4Args3<T1, T2, T3, T4, A1, A2, A3> filter3(Pr1<? super A3> p3) {
                return new Iterative4Args3Impl<T1, T2, T3, T4, A1, A2, A3>(this.left, this.right.filter3(p3), this.cross);
            }
    ...
    public static interface Iterative4Args2<T1, T2, T3, T4, A1, A2> extends Iterative4Args<T1, T2, T3, T4> {
        ...
        public static class Iterative4Args2Impl<T1, T2, T3, T4, A1, A2> implements Iterative4Args2<T1, T2, T3, T4, A1, A2> {
            ...
            public <R1, R2, R3, R4> Iterative4<R1, R2, R3, R4> inverseMapping(Fn3<? super A1, ? super A2, ? super T1, ? extends R1> f1, Fn3<? super A1, ? super A2, ? super T2, ? extends R2> f2, Fn3<? super A1, ? super A2, ? super T3, ? extends R3> f3, Fn3<? super A1, ? super A2, ? super T4, ? extends R4> f4) {
                return this.mapping((Fn3 & Serializable)(t1, a1, a2) -> f1.apply(a1, a2, t1), (Fn3 & Serializable)(t2, a1, a2) -> f2.apply(a1, a2, t2), (Fn3 & Serializable)(t3, a1, a2) -> f3.apply(a1, a2, t3), (Fn3 & Serializable)(t4, a1, a2) -> f4.apply(a1, a2, t4));
            }
            ...
            public <R1, R2> Iterative4Args2<T1, T2, T3, T4, R1, R2> map(Fn1<? super A1, ? extends R1> f1, Fn1<? super A2, ? extends R2> f2) {
                return new Iterative4Args2Impl<T1, T2, T3, T4, R1, R2>(this.left, this.right.map(f1, f2), this.cross);
            }

            @Override
            public <R1> Iterative4Args2<T1, T2, T3, T4, R1, A2> map1(Fn1<? super A1, ? extends R1> f1) {
                return new Iterative4Args2Impl<T1, T2, T3, T4, R1, A2>(this.left, this.right.map1(f1), this.cross);
            }

            @Override
            public <R2> Iterative4Args2<T1, T2, T3, T4, A1, R2> map2(Fn1<? super A2, ? extends R2> f2) {
                return new Iterative4Args2Impl<T1, T2, T3, T4, A1, R2>(this.left, this.right.map2(f2), this.cross);
            }
            ...
            public Iterative4Args2<T1, T2, T3, T4, A1, A2> filter(Pr1<? super A1> p1, Pr1<? super A2> p2) {
                return new Iterative4Args2Impl<T1, T2, T3, T4, A1, A2>(this.left, this.right.filter(p1, p2), this.cross);
            }

            @Override
            public Iterative4Args2<T1, T2, T3, T4, A1, A2> filter1(Pr1<? super A1> p1) {
                return new Iterative4Args2Impl<T1, T2, T3, T4, A1, A2>(this.left, this.right.filter1(p1), this.cross);
            }

            @Override
            public Iterative4Args2<T1, T2, T3, T4, A1, A2> filter2(Pr1<? super A2> p2) {
                return new Iterative4Args2Impl<T1, T2, T3, T4, A1, A2>(this.left, this.right.filter2(p2), this.cross);
            }
    ...
    public static interface Iterative4Args1<T1, T2, T3, T4, A1> extends Iterative4Args<T1, T2, T3, T4> {
        ...
        public static class Iterative4Args1Impl<T1, T2, T3, T4, A1> implements Iterative4Args1<T1, T2, T3, T4, A1> {
            ...
            public <R1, R2, R3, R4> Iterative4<R1, R2, R3, R4> inverseMapping(Fn2<? super A1, ? super T1, ? extends R1> f1, Fn2<? super A1, ? super T2, ? extends R2> f2, Fn2<? super A1, ? super T3, ? extends R3> f3, Fn2<? super A1, ? super T4, ? extends R4> f4) {
                return this.mapping((Fn2 & Serializable)(t1, a1) -> f1.apply(a1, t1), (Fn2 & Serializable)(t2, a1) -> f2.apply(a1, t2), (Fn2 & Serializable)(t3, a1) -> f3.apply(a1, t3), (Fn2 & Serializable)(t4, a1) -> f4.apply(a1, t4));
            }
            ...
            public <R1> Iterative4Args1<T1, T2, T3, T4, R1> map(Fn1<? super A1, ? extends R1> f1) {
                return new Iterative4Args1Impl<T1, T2, T3, T4, R1>(this.left, this.right.map(f1), this.cross);
            }
            ...
            public Iterative4Args1<T1, T2, T3, T4, A1> filter(Pr1<? super A1> p1) {
                return new Iterative4Args1Impl<T1, T2, T3, T4, A1>(this.left, this.right.filter(p1), this.cross);
            }
