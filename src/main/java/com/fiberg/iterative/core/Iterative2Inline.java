...
public interface Iterative2Inline<T1, T2> extends Iterative2<T1, T2> {
    ...
    @Override
    public <T3> Iterative3Inline<T1, T2, T3> pushBackBy(Iterable<? extends Stream<? extends T3>> i1);

    @Override
    public <T0> Iterative3Inline<T0, T1, T2> pushFrontBy(Iterable<? extends Stream<? extends T0>> i1);

    @Override
    public <T0> Iterative3Inline<T0, T1, T2> pushFrontCrossBy(Iterable<? extends Stream<? extends T0>> i1);

    @Override
    public <T0> Iterative3Inline<T0, T1, T2> pushFrontInlineBy(Iterable<? extends Stream<? extends T0>> i1);

    @Override
    public <R1, R2> Iterative2Inline<R1, R2> map(Fn1<? super T1, ? extends R1> f1, Fn1<? super T2, ? extends R2> f2);

    @Override
    public <R1, R2> Iterative2Inline<R1, R2> inlineMap(Fn1<? super T1, ? extends Iterable<? extends R1>> f1, Fn1<? super T2, ? extends Iterable<? extends R2>> i2);
